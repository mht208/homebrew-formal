...
class Picosat951 < Formula
  ...
  def install
    ...
    system "make"
    bin.install "picosat" => "picosat951",
                "picogcnf" => "picogcnf951",
                "picomcs" => "picomcs951",
                "picomus" => "picomus951"
    (lib/"picosat-951").install "libpicosat.a", "libpicosat.dylib"
    (include/"picosat-951").install "picosat.h"
  end
end
